...
{
    public  class RevenantQuickChargeBehavior : RevenantBaseBehavior
    {
        ...
        public override bool CustomCanBeActivated()
        {
            ...
            return f < 1.5f && CooldownIsFull() == true && Rage > 2.5f;
        }
        ...
        public override void OnUpdated()
        {
            ...
            if (f < 3f) 
            {
                if (Rage < 5)
                {
                    Rage += BraveTime.DeltaTime * (3 - f);
                }
            }
            else if (Rage > 0)
            {
                Rage -= BraveTime.DeltaTime;
            }
        }
        ...
        public IEnumerator StartPew()
        {
            ...
            this.controller.AIAnimator.PlayForDuration("chargeup", 0.75f, true, null, -1f, false);
            ...
            this.controller.AIAnimator.PlayForDuration("charge", 0.4f, true, null, -1f, false);
            ...
            while (f < 0.3f)
            {
                ...
                Body.Velocity = vector.normalized * Mathf.Lerp(0, 20, f * 4);
        ...
        public void OnTouchedPlayer(PlayerController player, GameObject REVENANT)
        {
            ...
            {
                player.healthHaver.ApplyDamage(0.5f, Vector2.zero, "Revenant", CoreDamageTypes.None, DamageCategory.Normal, true, null, false);
            }
        }
        public void OnTouchedEnemy(AIActor enemy, GameObject REVENANT)
        {
            if (speculator.ShouldSpeculate == true)
            {
                enemy.healthHaver.ApplyDamage(2f, Vector2.zero, "Revenant", CoreDamageTypes.None, DamageCategory.Normal, true, null, false);
            }
        }

        public override float CooldownVariance => 0;
