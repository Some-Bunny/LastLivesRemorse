...
namespace LastLivesRemorse
{
    public static class ConsoleMagic
    {
        ...
        public static void LogButCool(string text, Texture texture)
        {
            ...
            container.Background = new Color(0, 0, 0, 0);
...
namespace SGUI
{
    ...
    {
        float startTime;
        Color defaultColor = new Color(0.5f, 0.04f, 0.1f);
        Color defaultColor2 = new Color(0.95f, 0.24f, 0.01f);
        float offset;
        float freq;
        float amp;
        ...
        public override void Update()
        {
            ...
            Elem.Foreground = Color.Lerp(defaultColor, defaultColor2, y += offset);
